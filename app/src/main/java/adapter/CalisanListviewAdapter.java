...
public class CalisanListviewAdapter extends BaseAdapter {
    Context mContext;
    ...
    private static final String url_calisan_sil = "http://www.sihader.org/mehmet/calisan_sil.php";
    private static final String TAG_SUCCESS = "success" ;
    private static final String TAG_MESSAGE = "message" ;

    public CalisanListviewAdapter(Context context, List<Kisiler> kisilerlist) {
        mContext = context;
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AlertDialog show = new AlertDialog.Builder(mContext)
                        ...
                        .setMessage("Çalışanı Silmek İstediğinize Emin misiniz?")
