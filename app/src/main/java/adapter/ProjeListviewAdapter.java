...
public class ProjeListviewAdapter  extends BaseAdapter {
    Context mContext;
    ...
    private static final String url_proje_sil = "http://www.sihader.org/mehmet/proje_sil.php";
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";

    public ProjeListviewAdapter(Context context, List<Kisiler> kisilerlist) {
        mContext = context;
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AlertDialog show = new AlertDialog.Builder(mContext)
                        .setTitle("Proje Sil")
                        .setMessage("Projeyi Silmek İstediğinize Emin misiniz?")
    ...
    class Calisan_Delete extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jsonParser.makeHttpRequest(url_proje_sil, "POST", params);
